// https://github.com/soywiz-archive/haxe-openfl-opus/blob/b69ff5e0ec8136809d4a9ab22b28317fe7ca631d/project/common/ExternalInterface.cpp
#ifndef STATIC_LINK
...
static value hxopus_to_bytes_data(value data_buffer_value, value rate_value)
{
	MemoryStream fin;
...
DEFINE_PRIME2(hxopus_to_bytes_data);
...
DEFINE_PRIME0(opus_get_version_string);
